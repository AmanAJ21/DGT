    ...
    <div ref={wrapRef} className={`pc-card-wrapper ${className}`.trim()} style={cardStyle}>
                ...
                <div className="pc-user-info">
                  <div className="pc-user-details">
                    ...
                    <div className="pc-user-text">
                      ...
                      {email && (
                        <a href={`mailto:${email}`} className="pc-contact-link" style={{ pointerEvents: 'auto' }}>
                          {email}
                        </a>
                      )}
                      {phone && (
                        <a href={`tel:${phone}`} className="pc-contact-link" style={{ pointerEvents: 'auto' }}>
                          {phone}
                        </a>
                      )}
                      {!email && !phone && <div className="pc-status">{status}</div>}
                    </div>
                  </div>
                  <button
      ...
      {linkedin && (
        <div className="pc-linkedin-wrapper">
          ...
          >
            <svg className="pc-linkedin-icon" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
