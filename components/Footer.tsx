        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/services" className="text-gray-400 hover:text-blue-400 transition-colors flex items-center group">
                  <span className="w-1.5 h-1.5 bg-blue-400 rounded-full mr-2 opacity-0 group-hover:opacity-100 transition-opacity" />
                  Services
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start text-gray-400">
                ...
                <a href="mailto: india@dgtlogistics.in" className="hover:text-blue-400 transition-colors">
